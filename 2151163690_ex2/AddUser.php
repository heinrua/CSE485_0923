                    ...
                    <form action="add_db.php" method="post" class="text-secondary ">
                        <div class="row mt-4">
                            ...
                            <div class="row">
                                ...
                                <input type="text" name="u_name" id="" class="form-control " placeholder="User Name" required>
                                
                                <label for=""class="mt-4">Email <span class="text-danger">*</span></label> <br>
                                <input type="email" name="e_mail" id="" class="form-control " placeholder="Email" required>
                               
                                <label for=""class="mt-4">Phone Number <span class="text-danger">*</span></label> <br>
                                <input type="number" name="p_number" id="" class="form-control " placeholder="Phone Number" required>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-4">
                                ...
                                <select class="custom-select form-control " name="p_ostion" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="datetime" name="d_time" id="" class="form-control" required>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="f_url" id="" class="form-control" placeholder="Facebook Url">
                            </div>
                            <div class="col-md-4">
                                <label for="">Twitter Url</label> <br>
                                <input type="text" name="t_url" id="" class="form-control" placeholder="Twitter Url">
                            </div>
                            <div class="col-md-4">
                                <label for="">Linkedin Url</label> <br>
                                <input type="text" name="l_url" id="" class="form-control" placeholder="Linkedin Url">
                            </div>
                        </div>
                        <div class="mt-4">
                            <label for="">About</label> <br>
                            <textarea class="form-control" name="about_y" id="exampleFormControlTextarea1" rows="5" placeholder="Write About Yourself..."></textarea>
                        </div>
                        ...
                        <button type="submit" name="add_user" class="btn btn-success mt-4 mb-5">Save</button>
